    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_images', models.ImageField(storage=django.core.files.storage.FileSystemStorage(location='/media/images/'), upload_to='blog-images/', validators=[blog.models.validate_image])),
